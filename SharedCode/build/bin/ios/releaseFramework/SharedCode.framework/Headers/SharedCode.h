...
@protocol SharedCodeObservable, SharedCodeMainContractPresenter, SharedCodeMainContractView, SharedCodeDisposable, SharedCodeObservableStatic, SharedCodeKotlinIterator;
...
__attribute__((swift_name("Rx")))
@interface SharedCodeRx : KotlinBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)rx __attribute__((swift_name("init()")));
@property id<SharedCodeObservable> observable __attribute__((swift_name("observable")));
@end;
...
- (instancetype)initWithView:(id<SharedCodeMainContractView>)view __attribute__((swift_name("init(view:)"))) __attribute__((objc_designated_initializer));
- (void)onViewStart __attribute__((swift_name("onViewStart()")));
@end;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ObservableCompanion")))
@interface SharedCodeObservableCompanion : KotlinBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (getter=static, setter=setStatic:) id<SharedCodeObservableStatic> static_ __attribute__((swift_name("static_")));
@end;

__attribute__((swift_name("ObservableStatic")))
@protocol SharedCodeObservableStatic
@required
